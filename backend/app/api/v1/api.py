...
from app.api.v1.endpoints import auth, users, locations, vehicles, routes, tickets, incidents, reports, websocket, bookings, reviews, student_routing
...
api_router.include_router(student_routing.router, prefix="/student-routing", tags=["Student Bus VRPTW Optimization"])
